...
const mapStateToProps = (state, ownProps) => ({ // 2nd parameter ownProps is the props of the CollectionPage component that is being wrapped inside the connect function below
