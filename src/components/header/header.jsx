...
const Header = (
    { currentUser, hidden, signOutStart }, // currentUser here will contain the initial null value because of the mapStateToProps function below
) => (
    <HeaderContainer>
        <LogoContainer to="/">
            <Logo className="logo" />
...
const mapStateToProps = state =>
    createStructuredSelector({
        // state argument is automatically passed in by this createStructuredSelector call
...
export default connect(mapStateToProps, mapDispatchToProps)(Header); // Header component is exported with the redux state in-built
