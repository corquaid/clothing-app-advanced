...
const CartDropdown = ({ cartItems, history, dispatch }) => ( // cartItems from props, history also, dispatch refers to mapDispatchToProps, it can be passed in singly from connect() 
